...
def pre_process_main_BPTI():
    ...
    test_names = ["BPTI_af_dirty", "BPTI_af_clean", "BPTI_1Start", "BPTI_10Start", "BPTI_MD_TFES"]
    test_names = [
        "BPTI_af_dirty",
        "BPTI_af_clean",
        "BPTI_shaw_400",
    ...
    badMD_top_path = f"{regular_MD_base}/BPTI_test_concatenated_stripped.pdb"
    badMD_traj_path = [badMD_top_path.replace(".pdb", ".xtc")]

    goodMD_top_path = f"{regular_MD_base}/BPTI_10_c_combined.pdb"
    ...
    TFES_traj_path = [
        "/home/alexi/Documents/interpretable-hdxer/data/si_ifg1/T-FES/BPTI/resampled_outputs/BPTI_sampled.xtc"
    ]
