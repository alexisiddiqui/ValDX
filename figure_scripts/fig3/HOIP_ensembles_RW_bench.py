...
def pre_process_main():
    ...
    test_names = ["HOIP_af_dirty", "HOIP_af_clean"]
    ...
    dirty_traj_paths = ["/home/alexi/Documents/ValDX/raw_data/HOIP/HOIP_apo/HOIP_apo697_1_af_sample_127_10000_protonated.xtc"]
