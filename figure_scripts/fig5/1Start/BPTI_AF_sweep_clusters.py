...
def pre_process_main_BPTI():
    ...
    TFES_top_path = "/home/alexi/Documents/interpretable-hdxer/data/si_ifg1/T-FES/BPTI/BPTI_overall_combined_stripped.pdb"
    TFES_traj_path = ["/home/alexi/Documents/interpretable-hdxer/data/si_ifg1/T-FES/BPTI/resampled_outputs/BPTI_sampled.xtc"]
    # TFES_traj_path = ["/home/alexi/Documents/interpretable-hdxer/data/si_ifg1/T-FES/BPTI/BPTI_overall_combined_stripped.xtc"]
    regular_MD_base = "/home/alexi/Documents/ValDX/raw_data/full_length_regular_MD"

    top_path = f"{regular_MD_base}/BPTI_test_concatenated_stripped.pdb"
    traj_paths = [top_path.replace(".pdb", ".xtc")]
...
VDX.run_sweep_cluster_ensemble(system=test_name,
                                ...
                                expt_name=expt_name,
                                n_reps=3,
                                denoms = np.array([0, 2, 5, 10, 20, 100, 1000]),
                                split_modes=['R3','Sp'],
                                hdx_path=hdx_path,
                                segs_path=segs_path,
