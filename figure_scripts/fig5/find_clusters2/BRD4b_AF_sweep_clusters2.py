...
def pre_process_main():
    ...
    segs_name = "BRD4b_APO_segs.txt"
    segs_path = os.path.join(BPTI_dir, segs_name)

    hdx_name = "BRD4b_APO_clean.dat"
...
settings.drop_centrality = False
settings.hard_intersection = True
# combined_analysis_dump, names, save_paths = VDX.run_benchmark_ensemble(system=test_name,
#                                                                         times=times,
#                                                                         expt_name=expt_name,
#                                                                         n_reps=4,
