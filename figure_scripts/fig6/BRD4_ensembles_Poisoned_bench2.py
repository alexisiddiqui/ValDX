...
def pre_process_main_BRD4():
    # BRD4 experimental data paths
    BRD4_dir = "/home/alexi/Documents/ValDX/raw_data/BRD4/BRD4_APO"

    # BRD4_dir = "/home/alexi/Documents/ValDX/raw_data/HDXer_tutorial/BRD4"

    os.listdir(BRD4_dir)

    segs_name = "BRD4_APO_segs_trimmed.txt"
    segs_path = os.path.join(BRD4_dir, segs_name)

    hdx_name = "BRD4_APO_clean_trimmed.dat"
    hdx_path = os.path.join(BRD4_dir, hdx_name)
    print(hdx_path)

    rates_name = "out__train_MD_Simulated_1Intrinsic_rates.dat"
    rates_path = os.path.join(BRD4_dir, rates_name)
    
    # Base paths
    base_path = "/home/alexi/Documents/interpretable-hdxer/notebooks/Figure_5_Poisoned_Ensemble/combined_ensembles/BRD4"
    regular_MD_base = "/home/alexi/Documents/ValDX/raw_data/full_length_regular_MD"

    # Define ensembles and their properties
    ensembles = {
        # "AF2-MSAss": {
        #     "top": "/home/alexi/Documents/interpretable-hdxer/data/si_ifg1/json_corrected/BRD4_APO_484_1_af_sample_127_10000_protonated.pdb",
        # },
        # "AF2-Cleaned": {
        #     "top": "/home/alexi/Documents/interpretable-hdxer/data/si_ifg1/json_corrected/BRD4_APO_484_1_af_sample_127_10000_protonated.pdb"
        # },
        # "T-FES": {
        #     "top": "/home/alexi/Documents/interpretable-hdxer/data/si_ifg1/T-FES/BRD4/final/BRD4_overall_combined_stripped.pdb",
        # },
        # "1Start-MD": {
    ...
    poison_methods = ["shuffle-backbone-protons"]
    ...
    for ensemble_name, ensemble_data in ensembles.items():
        for method in poison_methods:
            for level in poison_levels:
                ...
                test_name = f"BRD4_{ensemble_name}_{short_method}_p{level}"
...
# %%
hdx_path, segs_path, rates_path, top_paths, traj_paths, sim_name, expt_name, test_names = pre_process_main_BRD4()
