...
def pre_process_main_BPTI():
    ...
    test_names = ["BPTI_af_dirty", "BPTI_af_clean", "BPTI_shaw_400", "BPTI_MD_Bad", "BPTI_MD_Good", "BPTI_MD_Good+Bad"]
    ...
    top_paths = [dirty_top_path, clean_top_path, shaw_top_path, badMD_top_path, goodMD_top_path, goodMD_top_path]
    traj_paths = [dirty_traj_paths[0], clean_traj_paths[0], shaw_traj_paths[0], badMD_traj_path[0], goodMD_traj_path[0], [goodMD_traj_path[0], badMD_traj_path[0]]]
...
for idx ,(test_name, top_path, traj_paths) in enumerate(zip(test_names[1:2], top_paths[1:2], traj_paths[1:2])):
    # if idx < 5:
    #     continue
