...
def pre_process_main_BPTI():
    ...
    trajectory_path = "/home/alexi/Documents/ValDX/figure_scripts/jaxent_autovalidation/_TeaA/trajectories/TeaA_initial_sliced.xtc"
...
for idx, (test_name, top_path, traj_paths) in enumerate(
    ...
    settings.train_frac = 0.6
    settings.RW_exponent = [
        -2,
        -1,
        0,
        1,
