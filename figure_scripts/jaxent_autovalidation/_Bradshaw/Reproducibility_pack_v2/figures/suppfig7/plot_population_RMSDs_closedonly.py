...
init_line, = ax.plot(binmidp, n, label="No reweighting", lw=4, c='cbf_sky_blue')
segs_lines = []
...
#axs[0].legend()
leg_1 = ax.legend([init_line], ["No reweighting"], loc=(0.30,0.91), ncol=1)
fullnames = []
for name in names:
    fullnames.append(name + " mixture")
leg_2 = ax.legend(segs_lines, fullnames, loc=(0.30,0.65), ncol=1)
...
plt.tight_layout()
plt.savefig("population_comparison_RMSDs_closedonly.pdf", dpi=300)
