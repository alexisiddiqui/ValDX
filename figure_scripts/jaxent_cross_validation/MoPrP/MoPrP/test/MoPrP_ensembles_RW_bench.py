...
def pre_process_main_MoPrP():
    ...
    trajectory_path = "/home/alexi/Documents/ValDX/figure_scripts/jaxent_cross_validation/MoPrP/MoPrP/all_clusters.xtc"
...
# save length of time taken to file
with open("time.txt", "w") as f:
    f.write(f"Time taken: {end_time - start_time} s\n")
    f.write(f"Time taken: {(end_time - start_time) / 60} min\n")
