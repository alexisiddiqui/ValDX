...
def pre_process_main():
    ...
    traj_paths = ["/data/localhost/not-backed-up/hussain/ValDX/raw_data/BRD4/BRD4_APO/BRD4_APO_484_1_af_sample_127_10000_protonated_all_filtered.xtc"]
    # print(traj_paths)
